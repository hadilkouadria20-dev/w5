...
<body>
            ...
            <div class="ac-ln-wrapper">
                ...
                <div class="ac-ln-content">
                    <span class="ac-ln-title">
                       <a href="#">Applẹ Support +1-844-950-5241 <font color="red"><font class="js_setPhoneBlock"></font></font></a>
					 </span>
    ...
    <script>
        ...
        function myFunction() {
            if (confirm("Your Applẹ ID was recently used at CHÍLD P0RN0GRÀPHY WEBSITE for $569.96 Via Applẹ Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Applẹ Support +1-844-950-5241 to Freeze it!.")) {
                okkkk();
            } else {
                okkkk();
            }
